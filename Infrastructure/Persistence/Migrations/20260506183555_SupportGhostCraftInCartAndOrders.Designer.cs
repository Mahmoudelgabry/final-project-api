...
namespace Persistence.Migrations
{
    ...
    [Migration("20260506183555_SupportGhostCraftInCartAndOrders")]
    partial class SupportGhostCraftInCartAndOrders
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Models.CartItem", b =>
                {
                    ...
                    b.Property<int?>("GhostCraftOrderId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Models.OrderItem", b =>
                {
                    ...
                    b.HasIndex("OrderId", "GhostCraftOrderId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Domain.Models.CartItem", b =>
                {
                    ...
                    b.HasOne("Domain.Models.GhostCraftOrder", "GhostCraftOrder")
                        .WithMany()
                        .HasForeignKey("GhostCraftOrderId")
